...
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Facade v1**                 | `inspect_document`, `read_content`, `search_document`, `preview_edit`, `apply_edit`                                                                                                                                                                                                                                                                                                                                                                            | Preferred bounded first-wave workflows for routed inspect/read/search and preview-token-first active field/surface edits                                                   |
...
- `tools/list` exposes additive metadata in `_meta`; use `risutoki/surfaceKind` and `risutoki/recommendation` to prefer facade routes, and `risutoki/requiresConfirmation` / `risutoki/supportsDryRun` instead of guessing which write routes can preview first or will block on approval.
