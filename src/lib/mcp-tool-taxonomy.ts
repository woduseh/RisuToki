...
export const TOOL_STALE_GUARD_NAMES: Record<string, readonly string[]> = {
  ...
  write_lorebook_by_id: ['expected_comment'],
  write_lorebook_batch: ['expected_comment'],
  write_lorebook_by_id_batch: ['expected_comment'],
  clone_lorebook: ['expected_comment'],
  delete_lorebook: ['expected_comment'],
  delete_lorebook_by_id: ['expected_comment'],
  batch_delete_lorebook: ['expected_comments'],
  batch_delete_lorebook_by_id: ['expected_comments'],
  ...
  write_risup_prompt_item_by_id: ['expected_type', 'expected_preview'],
  write_risup_prompt_item_batch: ['expected_type', 'expected_preview'],
  write_risup_prompt_item_by_id_batch: ['expected_type', 'expected_preview'],
  delete_risup_prompt_item: ['expected_type', 'expected_preview'],
  delete_risup_prompt_item_by_id: ['expected_type', 'expected_preview'],
  batch_delete_risup_prompt_items: ['expected_types', 'expected_previews'],
  batch_delete_risup_prompt_items_by_id: ['expected_types', 'expected_previews'],
};
...
export const TOOL_STALE_GUARD_DETAILS: Record<string, readonly StaleGuardDetail[]> = {
  ...
  write_lorebook_by_id: [expectedComment()],
  write_lorebook_batch: [expectedComment('/entries/*/expected_comment', '/entries/*/index')],
  write_lorebook_by_id_batch: [expectedComment('/entries/*/expected_comment', '/entries/*/id')],
  clone_lorebook: [expectedComment()],
  delete_lorebook: [expectedComment()],
  delete_lorebook_by_id: [expectedComment()],
  ...
  batch_delete_lorebook_by_id: [
    staleGuardDetail('expected_comments', '/expected_comments/*', STALE_GUARD_SOURCES.lorebookComment, '/ids/*'),
  ],
  ...
  write_risup_prompt_item_by_id: [expectedRisupType(), expectedRisupPreview()],
  ...
  write_risup_prompt_item_by_id_batch: [
    expectedRisupType('/writes/*/expected_type', '/writes/*/item_id'),
    expectedRisupPreview('/writes/*/expected_preview', '/writes/*/item_id'),
  ],
  delete_risup_prompt_item: [expectedRisupType(), expectedRisupPreview()],
  delete_risup_prompt_item_by_id: [expectedRisupType(), expectedRisupPreview()],
  ...
  batch_delete_risup_prompt_items_by_id: [
    staleGuardDetail('expected_types', '/expected_types/*', STALE_GUARD_SOURCES.risupPromptType, '/item_ids/*'),
    staleGuardDetail(
      'expected_previews',
      '/expected_previews/*',
      STALE_GUARD_SOURCES.risupPromptPreview,
      '/item_ids/*',
    ),
  ],
};
