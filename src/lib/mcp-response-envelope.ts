...
export const FAMILY_NEXT_ACTIONS: Record<ToolFamily, string[]> = {
  ...
  'item-management': ['manage_items', 'read_content', 'validate_content'],
...
export const TOOL_NEXT_ACTIONS: Partial<Record<keyof typeof TOOL_TAXONOMY, string[]>> = {
  ...
  read_risup_prompt_item_by_id: ['preview_edit', 'apply_edit', 'diff_risup_prompt'],
  write_risup_prompt_item: ['list_risup_prompt_items', 'read_risup_formating_order', 'diff_risup_prompt'],
  write_risup_prompt_item_by_id: ['list_risup_prompt_items', 'read_risup_formating_order', 'diff_risup_prompt'],
  write_risup_prompt_item_batch: ['list_risup_prompt_items', 'read_risup_formating_order', 'diff_risup_prompt'],
  write_risup_prompt_item_by_id_batch: ['list_risup_prompt_items', 'read_risup_formating_order', 'diff_risup_prompt'],
  ...
  batch_delete_risup_prompt_items_by_id: ['list_risup_prompt_items', 'read_risup_formating_order'],
  delete_risup_prompt_item_by_id: ['list_risup_prompt_items', 'read_risup_formating_order'],
  read_lorebook_by_id: ['preview_edit', 'apply_edit', 'validate_lorebook_keys'],
  write_lorebook_by_id: ['list_lorebook', 'validate_lorebook_keys', 'diff_lorebook'],
  write_lorebook_by_id_batch: ['list_lorebook', 'validate_lorebook_keys'],
  delete_lorebook_by_id: ['list_lorebook', 'validate_lorebook_keys'],
  batch_delete_lorebook_by_id: ['list_lorebook', 'validate_lorebook_keys'],
  read_regex_by_identity: ['preview_edit', 'apply_edit'],
  write_regex_by_identity: ['list_regex', 'read_regex_by_identity'],
  delete_regex_by_identity: ['list_regex'],
  read_greeting_by_hash: ['preview_edit', 'apply_edit'],
  write_greeting_by_hash: ['list_greetings', 'read_greeting_by_hash'],
  delete_greeting_by_hash: ['list_greetings'],
};
