...
| **risup 프롬프트**      | `list_risup_prompt_items`, `read_risup_prompt_item`, `write_risup_prompt_item`, `read_risup_formating_order`, `write_risup_formating_order`                                                                     | `.risup`의 구조화 프롬프트 편집                                           |
