...
For agent-facing guidance on generating this style without treating the method as dogma, see [SELF_INTRODUCTION.md](../../skills/authoring-bots/SELF_INTRODUCTION.md).
