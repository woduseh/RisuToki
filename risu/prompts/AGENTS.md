...
Use shared syntax references when needed. Exact preset fields live in `risu/prompts/docs/PRESET_FIELDS.md`; Phēmē's contract lives in `risu/prompts/docs/families/PHEME.md`.
