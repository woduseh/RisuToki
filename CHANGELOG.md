...
- **엔트리포인트 라우팅 일관성 수정**: `AGENTS.md`, `docs/MCP_WORKFLOW.md`, `README.md`에서 `project-workflow` 스킬을 프로젝트 온보딩 시작점으로 일관되게 안내하도록 수정했습니다. `using-mcp-tools`는 MCP 도구 선택 상세 스킬로 유지합니다.
