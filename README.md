...
[![Version](https://img.shields.io/badge/version-1.4.0-blue.svg)](https://github.com/woduseh/RisuToki/releases)
...
| Category             | Tools                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Facade v1**        | `list_tool_profiles` · `inspect_document` · `read_content` · `search_document` · `preview_edit` · `apply_edit` · `validate_content` · `load_guidance` · `manage_items` · `manage_assets` · `manage_file` — bounded/profiled workflow entrypoints, including external lorebook/regex/greeting/trigger/Lua/CSS and `.risup` prompt item read/preview/apply/validate, active/external `.charx` export compatibility validation, active/external surface patch preview/apply, `.risup` prompt item/snippet management, lorebook/regex/alternate greeting/trigger/Lua/CSS add/reorder, `.charx`/`.risum` asset list/read/add/delete/rename plus `.charx` compression, guarded file/session/project-folder management, and runtime health metadata |
...
| **Assets**           | facade: `manage_assets` for covered active/external `.charx`/`.risum` asset list/read/add/delete/rename plus `.charx` compression / granular: `list_charx_assets` · `read_charx_asset` · `add_charx_asset` · `delete_charx_asset` · `rename_charx_asset` · `list_risum_assets` · `read_risum_asset` · `add_risum_asset` · `delete_risum_asset` · `compress_assets_webp`                                                                                                                                                                                                                                                                                                                                                                      |
...
- Via MCP, the preferred `manage_assets` facade handles active/external `.risum` asset list/read/add/delete/rename through preview-first workflows with collection and stale-path guards; use granular asset routes for exact legacy payloads or unsupported asset operations such as `.risum` compression.
