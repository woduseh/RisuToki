...
[![Version](https://img.shields.io/badge/version-0.31.0-blue.svg)](https://github.com/woduseh/RisuToki/releases)
...
| 🎭 **프리뷰 모드**    | CBS/Lua 렌더링 + 로어북 데코레이터 매칭/디버그 포함 채팅 시뮬레이션 (F5)                                                                                    |
