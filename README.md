...
| **References**     | `list_references` · `read_reference_field` · `search_in_reference_field` · `read_reference_field_range` + greeting/trigger/lorebook/Lua/CSS/regex/risup sub-query tools — works without a main file open                              |
