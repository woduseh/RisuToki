...
| **Bot Authoring**       | `authoring-media-mix`, `authoring-characters`, `authoring-worlds`, `authoring-scenarios`, `authoring-desire`, `trope-library`, `authoring-lorebook-bots`, `writing-translation-guides`, `critiquing-bots` | `.charx` composition plus cross-media IP, visual identity, world, event, desire, trope, translation, and critique |
| **Preset Authoring**    | `writing-risup-presets`, `prompt-family-development`, `prompt-family-maintenance`                                                                                                                         | `.risup` composition plus reusable prompt-family design and canonical-to-variant maintenance                      |
