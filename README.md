...
[![Version](https://img.shields.io/badge/version-0.34.0-blue.svg)](https://github.com/woduseh/RisuToki/releases)
...
| 🎭 **프리뷰 모드**    | CBS/Lua 렌더링 + 로어북 데코레이터 매칭/디버그 + 인라인 로딩/에러 진단 포함 채팅 시뮬레이션 (F5)                                                            |
...
- 정규식·인사말·Lua/CSS 섹션 도구의 4xx 에러는 `action`, `target`, `status`, `suggestion` 등의 구조화 필드를 포함하여 AI CLI가 에러를 자동 진단·복구할 수 있습니다
