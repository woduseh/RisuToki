...
| 🔧 **MCP 도구 40+종** | 필드·로어북·정규식·Lua/CSS 섹션·인사말·트리거·참고자료·Danbooru 태그·스킬 문서 읽기/쓰기 |
...
| 카테고리     | 도구                                                                                       |
| ------------ | ------------------------------------------------------------------------------------------ |
| **필드**     | `list_fields` · `read_field` · `write_field`                                               |
...
| **로어북**   | `list_lorebook` · `read_lorebook` · `write_lorebook` · `add_lorebook` · `delete_lorebook`  |
| **정규식**   | `list_regex` · `read_regex` · `write_regex` · `add_regex` · `delete_regex`                 |
