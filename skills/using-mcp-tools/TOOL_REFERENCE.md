...
- Prefer `list_reference_greetings` / `read_reference_greeting` and `list_reference_triggers` / `read_reference_trigger` over `read_reference_field("alternateGreetings")`, `read_reference_field("groupOnlyGreetings")`, or `read_reference_field("triggerScripts")`.
