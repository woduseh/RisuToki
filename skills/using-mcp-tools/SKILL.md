...
- Reference greetings/triggers: use `list_reference_greetings` / `read_reference_greeting` and `list_reference_triggers` / `read_reference_trigger` instead of dumping `alternateGreetings`, `groupOnlyGreetings`, or `triggerScripts`.
